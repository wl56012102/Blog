...
<head>
    ...
    <title>我的博客</title>
    <link href="14.css" type="text/css" rel="stylesheet">
</head>
<body>
...
<div id="container">
    <div id="globallink">
        <ul>
            <li><a href="#">个人首页</a></li>
            <li><a href="#">我的关注</a></li>
            <li><a href="UploadArticle.jsp">上传博文</a></li>
    ...
    <div id="parameter">
        <div id="author">
            ...
            <%
                out.print("<p>"+session.getAttribute("username")+"的BLOG</p>");
            %>
        ...
        <div id="llinks">
            ...
            <ul>
                ...
                <li><img src="images/3.gif"> <a href="#">我的关注</a></li>
                <li><img src="images/4.gif"> <a href="user_article.jsp">我的文章</a></li>
